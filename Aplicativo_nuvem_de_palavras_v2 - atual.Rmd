...
getTermMatrix <- memoise(function(x,excludeWords,ngrams=0,tf_idf=F,textStemming=F) {
...
Para dar início a construção da nuvem de palavras selecione o arquivo (em formato csv) que contenha apenas duas colunas em que:
...
Para remover palavras da nuvem de palavras (as palavras removidas são chamadas de stopwords), basta inserir as palavras, separadas por vírgula, na caixa "**Removendo palavras**". Exemplo de como devem ser inseridas as palavras:
...
**Importante**: Não é possível utilizar ngrams + Text Steamming
